...
<div class="sec_table">
    <h2>{{ $title }}</h2>
        <a href="/videosearch/create" class="sec_addnew">
            ...
            <tr>
                ...
                <td class="kolom_action">
                    ...
                    <div class="action_crud">
                        <a href="/videosearch/edit/{{ $d->id }}"><div class="list_action">
                        ...
                        <form action="/videosearch/delete/{{ $d->id }}" method="POST" id="deleteForm{{ $d->id }}" style="display:inline;">
                            @csrf
                            @method('DELETE')
