...
<div class="sec_table">
    <h2>{{ $title }}</h2>
        <a href="/websearch/create" class="sec_addnew">
            ...
            <tr>
                ...
                <td class="kolom_action">
                    ...
                    <div class="action_crud">
                        <a href="/websearch/edit/{{ $d->id }}"><div class="list_action">
                        ...
                        <form action="/websearch/delete/{{ $d->id }}" method="POST" id="deleteForm{{ $d->id }}" style="display:inline;">
                            @csrf
                            @method('DELETE')
