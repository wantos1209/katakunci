...
<div class="sec_box hgi-100">
    <div class="sec_form">
        ...
        <form action="/imagesearch/edit/{{ $id }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="list_form">
                        ...
                        <div class="imagesearch-input margin-30">
                            <div class="imagesearch-details">
                                ...
                                <div class="list_form">
                                    ...
                                    <input type="number" min=0 name="imageWidth[{{ $index }}]" value="{{ $image->imageWidth }}" placeholder="Input Image Width" required>
                                </div>
                                <div class="list_form">
                                    <span class="sec_label">Image Height</span>
                                    <input type="number" min=0 name="imageHeight[{{ $index }}]" value="{{ $image->imageHeight }}" placeholder="Input Image Height" required>
                                </div>
                                <div class="list_form">
                                    <span class="sec_label">Thumbnail Url</span>
                                    <input type="text" name="thumbnailUrl[{{ $index }}]" value="{{ $image->thumbnailUrl }}" placeholder="Input Thumbnail Url" required>
                                </div>
                                <div class="list_form">
                                    <span class="sec_label">Thumbnail Width</span>
                                    <input type="number" min=0 name="thumbnailWidth[{{ $index }}]" value="{{ $image->thumbnailWidth }}" placeholder="Input Thumbnail Width" required>
                                </div>
                                <div class="list_form">
                                    <span class="sec_label">Thumbnail Height</span>
                                    <input type="number" min=0 name="thumbnailHeight[{{ $index }}]" value="{{ $image->thumbnailHeight }}" placeholder="Input Thumbnail Height" required>
                                </div>
                                <div class="list_form">
                                ...
                                <div class="list_form">
                                    ...
                                    <input type="text" name="domain[{{ $index }}]" value="{{ $image->domain }}" placeholder="Input Domain" required>
                                </div>
                                <div class="list_form">
