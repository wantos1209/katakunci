    ...
    <table>
        <tbody>
            ...
            <tr>
                ...
                <td><span class="name">{{ $d->key }}</span></td>
                ...
                <td class="kolom_action">
                    ...
                    <div class="action_crud">
                        <a href="/keyword/edit/{{ $d->id }}"><div class="list_action">
                        ...
                        <form action="/keyword/delete/{{ $d->id }}" method="POST" id="deleteForm{{ $d->id }}" style="display:inline;">
                            @csrf
                            @method('DELETE')
