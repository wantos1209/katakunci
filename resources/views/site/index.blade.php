...
<div class="sec_table">
    <h2>{{ $title }}</h2>
        <a href="/site/create" class="sec_addnew">
    ...
    <table>
        <tbody>
            ...
            <tr>
                ...
                <td><span class="website">{{ $d->jenis === 1 ? 'website' : 'non-website' }}</span></td>
                ...
                <td class="kolom_action">
                    ...
                    <div class="action_crud">
                        <a href="/site/edit/{{ $d->id }}"><div class="list_action">
                        ...
                        <form action="/site/delete/{{ $d->id }}" method="POST" id="deleteForm{{ $d->id }}" style="display:inline;">
                            @csrf
                            @method('DELETE')
