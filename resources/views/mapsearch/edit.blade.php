...
<div class="sec_box hgi-100">
    <div class="sec_form">
        ...
        <form action="/mapsearch/edit/{{ $id }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="list_form">
                        ...
                        <div class="mapsearch-input margin-30">
                            <div class="mapsearch-details">
                                ...
                                <div class="list_form">
                                    ...
                                    <input type="text" name="address[{{ $index }}]" value="{{ $image->address }}" placeholder="Input Address" required>
                                </div>
                                <div class="list_form">
                                    <span class="sec_label">Latitude</span>
                                    <input type="text" name="latitude[{{ $index }}]" value="{{ $image->latitude }}" placeholder="Input Latitude" required class="latitude">
                                </div>
                                <div class="list_form">
                                    <span class="sec_label">Longitude</span>
                                    <input type="text" name="longitude[{{ $index }}]" value="{{ $image->longitude }}" placeholder="Input Longitude" required class="longitude">
                                </div>
                                <div class="list_form">
                                    <span class="sec_label">Rating</span>
                                    <input type="number" name="rating[{{ $index }}]" step="0.1" value="{{ $image->rating }}" placeholder="Input Rating" required>
                                </div>
                                <div class="list_form">
                                    <span class="sec_label">Rating Count</span>
                                    <input type="number" name="ratingCount[{{ $index }}]" value="{{ $image->ratingCount }}" placeholder="Input Rating Count" required>
                                </div>
                                <div class="list_form">
                                    <span class="sec_label">Phone Number</span>
                                    <input type="text" name="phoneNumber[{{ $index }}]" value="{{ $image->phoneNumber }}" placeholder="Input Phone Number" required>
                                </div>
                                <div class="list_form">
                                    <span class="sec_label">Category</span>
                                    <input type="text" name="category[{{ $index }}]" value="{{ $image->category }}" placeholder="Input Category" required>
                                </div>
                                 <div class="list_form">
                                    <span class="sec_label">Website</span>
                                    <input type="text" name="website[{{ $index }}]" value="{{ $image->website }}" placeholder="Input Website" required>
                                </div>
                                <div class="list_form">
                                    <span class="sec_label">Position</span>
                                    <input type="number" min=0 name="position[{{ $index }}]" placeholder="Input Position" value="{{ $image->position }}" required>
                                </div>
...
<script>
    $(document).ready(function () {
        ...
        // Menghapus mapsearch atau detail
